...
$(document).on("scroll", function () {
    //When the webpageis scrolled down from the top by 50px this
    //if statementwill trigger
    if ($(document).scrollTop() > 50) {
        ...
        //Adjust the positionof the mobile drop menu
        ...
        //is removedfrom the HTML element with the nav
        //class selector
...
//Close mobile menu when a navigationlink is clicked
$(document).ready(function() {
    ...
    $(".navbar-nav").on('click', '.nav-link:not(".dropdown-toggle"), .dropdown-item', function() {
        //Collapse the navbarwhen a link or dropdown item is clicked
